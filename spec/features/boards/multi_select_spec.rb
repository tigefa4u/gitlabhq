...
describe 'Multi Select Issue', :js do
  ...
  context 'with lists' do
    ...
    it 'does not move deselected issues', :js do
      multi_select('.board-card:nth-child(1)')
      multi_select('.board-card:nth-child(2)')
      multi_select('.board-card:nth-child(3)')
      multi_select('.board-card:nth-child(2)', 'deselect')
      ...
      page.within(all('.js-board-list')[2]) do
        expect(find('.board-card:nth-child(1)')).to have_content(issue1.title)
        expect(find('.board-card:nth-child(2)')).to have_content(issue3.title)
      end
    end
    ...
    it 'removes label on all moved issues', :js do
      multi_select('.board-card:nth-child(1)')
      multi_select('.board-card:nth-child(2)')
      ...
      page.within(all('.js-board-list')[0]) do
        expect(find('.board-card:nth-child(1)')).to have_content(issue1.title)
        expect(find('.board-card:nth-child(1)')).not_to have_content(label1.title)
        expect(find('.board-card:nth-child(2)')).to have_content(issue2.title)
        expect(find('.board-card:nth-child(2)')).not_to have_content(label1.title)
      end
    end

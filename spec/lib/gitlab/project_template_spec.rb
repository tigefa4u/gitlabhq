  ...
  describe '.all' do
    it 'returns a all templates' do
      expected = [
        ...
        described_class.new('iosswift', 'iOS (Swift)', 'A ready-to-go iOS Swift app.', 'https://gitlab.com/gitlab-org/project-templates/iosswift'),
        described_class.new('android', 'Android', 'A ready-to-go Android app.', 'https://gitlab.com/gitlab-org/project-templates/android'),

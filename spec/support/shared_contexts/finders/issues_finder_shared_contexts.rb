...
RSpec.shared_context 'IssuesFinder context' do
  ...
  let_it_be(:issue1) { create(:issue, author: user, assignees: [user], project: project1, milestone: milestone, title: 'gitlab', created_at: 1.week.ago, updated_at: 1.week.ago) }
  ...
  let_it_be(:issue4) { create(:issue, project: project3) }
